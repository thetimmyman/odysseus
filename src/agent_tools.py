...
# ---------------------------------------------------------------------------
MAX_AGENT_ROUNDS = 40  # was 20 - real multi-file repo tasks routinely need more exploration rounds
SHELL_TIMEOUT = 60
PYTHON_TIMEOUT = 30
...
TOOL_TAGS = {"bash", "python", "web_search", "web_fetch", "read_file", "write_file", "edit_file", "revert_file",
